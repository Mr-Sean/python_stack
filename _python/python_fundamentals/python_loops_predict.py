...
for num in range(10):
    if num % 2 == 0:
        ...
        print(num)
# Predict: Hello,1,Hello,3,Hello,5,Hello,7,Hello,9
...
for num in range(10):
    if num % 4 == 0:
        ...
        print(num)
# Predict: Hello,1,Hello,3,World,5,Hello,7,World,9
...
# Predict: name,age,trick,Fido,4,"rolls over"
...
# Predict: First, I will use the 20 minute rule and use the platform and other resources to find my answer
