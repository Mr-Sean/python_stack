...
# def ultimate_analysis(nums_list): #I could not get this to work!
...
def ultimate_analysis(lst):    #Attempt # 2
    # handle
    result = {
        'sum_total': None,
        'maximum': None,
...
# def reverse_list(nums_list):    #attempt # 1
#     list_len = (len(nums_list)
#     for idx in range(int(len(nums_list)/2)):    #get invalid syntax error
...
def reverse_list(lst):      #Attempt # 2
