...
tony.make_deposit(10)
tony.make_deposit(15)
tony.make_deposit(5)
tony.make_withdrawal(20)
tony.display_user_balance()

# Have the second user make 2 deposits and 2 withdrawals and then display their balance  
jimmy.make_deposit(20)
jimmy.make_deposit(30)
jimmy.make_withdrawal(10)
jimmy.make_withdrawal(5)
jimmy.display_user_balance()

# Have the third user make 1 deposits and 3 withdrawals and then display their balance  
danny.make_deposit(100)
danny.make_withdrawal(20)
danny.make_withdrawal(30)
danny.make_withdrawal(25)
